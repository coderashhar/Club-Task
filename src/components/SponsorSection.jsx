export default function SponsorsSection() {
    const sponsors = [
      { id: 1, name: "Frontify", logo: "src/assets/svg/logo1.svg" },
      { id: 2, name: "GoodData", logo: "src/assets/svg/logo2.svg" },
      { id: 3, name: "highradius", logo: "src/assets/svg/logo3.svg" },
      { id: 4, name: "Multiplier", logo: "src/assets/svg/logo4.svg" },
      { id: 5, name: "NordVPN", logo: "src/assets/svg/logo5.svg" },
      { id: 6, name: "MongoDB", logo: "src/assets/svg/logo6.svg" },
      { id: 7, name: "Jotform", logo: "src/assets/svg/logo7.svg" },
      { id: 8, name: "Swiggy", logo: "src/assets/svg/logo8.svg" },
    ];
